...
uint8_t moduloIP(uint8_t* mensaje, uint64_t longitud,uint16_t* pila_protocolos,void *parametros);
uint8_t moduloETH(uint8_t* mensaje, uint64_t longitud,uint16_t* pila_protocolos,void *parametros);
